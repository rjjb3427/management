...
class BeansControllerTest < ActionController::TestCase
  ...
  test "should create bean" do
    assert_difference('Bean.count') do
      post :create, bean: { bean_type: @bean.bean_type, description: @bean.description, name: @bean.name, supplier_id: @bean.supplier_id }
    end
  ...
  test "should update bean" do
    patch :update, id: @bean, bean: { bean_type: @bean.bean_type, description: @bean.description, name: @bean.name, supplier_id: @bean.supplier_id }
    assert_redirected_to bean_path(assigns(:bean))
  end
